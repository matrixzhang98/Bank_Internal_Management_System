...
<s:form method="post" theme="simple" action="%{progAction}" >
	...
	<div id="tb">
		<table width="100%" border="0" cellpadding="4" cellspacing="0" >
				...
				<td width="30%"><label><s:property value="labCustMst.custId" /></label></td>
				<td width="20%" class="colNameAlign required">*<s:text name="custName" />：</td>
				<td width="30%"><label><s:property value="labCustMst.custName" /></label></td>
			</tr>
			<tr class="trBgEven">
				<td width="20%" class="colNameAlign required">*<s:text name="custTel" />：</td>
				<td width="30%"><label><s:property value="labCustMst.custName" /></label></td>
				<td width="20%" class="colNameAlign">&nbsp;<s:text name="birthDate" />：</td>
				<td width="30%"><label><s:property value="labCustMst.birthDate" /></label></td>
			</tr>
			<tr class="trBgOdd">
				<td width="20%" class="colNameAlign required">*<s:text name="custAddr" />：</td>
				<td width="30%"><label><s:property value="labCustMst.custAddr" /></label></td>
				<td width="20%">&nbsp;</td>
				<td width="30%">&nbsp;</td>
			</tr>
			<tr class="trBgEven">
